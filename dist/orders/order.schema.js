...
__decorate([
    (0, mongoose_1.Prop)({ default: 'Cash on Delivery' }),
...
], Order.prototype, "isEmergency", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Order.prototype, "ratingFeedback", void 0);
exports.Order = Order = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true })
], Order);
exports.OrderSchema = mongoose_1.SchemaFactory.createForClass(Order);
exports.OrderSchema.index({ status: 1, createdAt: -1 });
exports.OrderSchema.index({ customerId: 1, status: 1 });
exports.OrderSchema.index({ driverId: 1, status: 1 });
